...
namespace FORM
{
    public partial class frmAdicao : MetroFramework.Forms.MetroForm
    {
        ...
        {
            SoundPlayer somErrou = new SoundPlayer(@"\FORM\Audios\errou.wav");
            SoundPlayer somAcertou = new SoundPlayer(@"\FORM\Audios\acertou.wav");
        ...
        {
            SoundPlayer somBotao = new SoundPlayer(@"\FORM\Audios\botao.wav");
            somBotao.Play();
            lbN1.Text = "";
            lbN2.Text = "";
            txtUsuario.Text = "";
